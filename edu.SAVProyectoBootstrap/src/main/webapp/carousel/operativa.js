...
function anyadirCarrito(x) {
	var listaProductos = [["Mechero Zenith Flame", "10", 1], ["Mechero Sparkle Blaze", "16", 1], ["Mechero Vintage Glow", "11", 1], ["Mechero Eco-Fire", "18", 1], ["Mechero Adventure Torch", "14", 1], ["Mechero Glamour Flare", "15", 1], ["MMechero Bohemian Blaze", "9", 1], ["Mechero Tech Spark", "112", 1], ["Mechero Clásico Elegance", "13", 1]];
...
function pedidos() {
	...
	alert(listaPedidos.length);
	var codigo = "";
	var articulo, mostrar;
	for (var i = 0; i < listaPedidos.length; i++) {
		articulo = listaPedidos[i];
		mostrar = `<div class="row border-top border-bottom">
					<div class="row main align-items-center">
						<div class="col-4">
							<svg class="bd-placeholder-img card-img-top" width="100%" height="225"
								xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: Thumbnail"
